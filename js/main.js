...
function displayYourFavSit(arr) {
  ...
  for (var i = 0; i < arr.length; i++) {
    ...
    <tr>
                                <td scope="row">${i + 1}</td>
                                <td>${arr[i].name}</td>
                                <td><button class="vist rounded-2"><a href="${arr[i].sitURl}" class="text-decoration-none" target="_blank"><span class="pe-1"><i class="fa-regular fa-eye"></i></span><span class="my-sp"">Visit</span> </a></button></td>
